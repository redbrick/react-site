const contactPage = {
  ...
  sections: [
    {
      heading: 'Committee',
      subtitle: 'committee@redbrick.dcu.ie',
      link: 'mailto:committee@redbrick.dcu.ie',
      paragraphs: [
    ...
    {
      heading: 'Admins',
      subtitle: 'admins@redbrick.dcu.ie',
      link: 'mailto:admins@redbrick.dcu.ie',
      paragraphs: [
        'This address can be used to contact the Admin team if you have any requests regarding your account or any special service requests.',
        'Please provide your Redbrick username (if applicable or you are not using your Redbrick email address) and in the case of getting unsubscribed to a mailing list the mailing list’s name and the email subscribed is very important.',
      ],
    ...
    {
      heading: 'Webmaster',
      subtitle: 'webmaster@redbrick.dcu.ie',
      link: 'mailto:webmaster@redbrick.dcu.ie',
      paragraphs: [
        'This address can be used to contact the Admin team if you have any requests regarding your account or any special service requests.',
        'Please provide your Redbrick username (if applicable or you are not using your Redbrick email address) and in the case of getting unsubscribed to a mailing list the mailing list’s name and the email subscribed is very important.',
      ],
    ...
    {
      heading: 'Helpdesk',
      subtitle: 'helpdesk@redbrick.dcu.ie',
      link: 'mailto:helpdesk@redbrick.dcu.ie',
      paragraphs: [
    ...
    {
      heading: 'Accouts & Finance',
      subtitle: 'treasurer@redbrick.dcu.ie',
      link: 'mailto:treasurer@redbrick.dcu.ie',
      paragraphs: [
    ...
    {
      heading: 'Abuse',
      subtitle: 'abuse@redbrick.dcu.ie',
      link: 'mailto:abuse@redbrick.dcu.ie',
      paragraphs: [
