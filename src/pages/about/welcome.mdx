...
Redbrick's primary servers are Azazel, Paphos, Pygmalion, Metharme, Hardcase,
Daedalus and Icarus. These provides the major services that you will be using
including programming environments, web services, and our IRC server.
...
Click [here](https://term.redbrick.dcu.ie) to open a terminal in your web
