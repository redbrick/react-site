...
const Joining = () => (
  <div className="Main Page-Section">
    ...
    <p>
      Membership is open to all past and present students and staff of Dublin City University, and
      St. Pat’s, Drumcondra.
    </p>
    <h2>Costs</h2>
    <p>
    ...
    <p>
      ...
      accounts@redbrick.dcu.ie. Then send an email to admins@redbrick.dcu.ie with your:
      <ul>
    ...
    <p>
      ...
      <a href="mailto:treaurer@redbrick.dcu.ie">treasurer</a> upon payment.
    </p>
    ...
    <p>
      Almost anything you want - providing the username is available and no more than eight
